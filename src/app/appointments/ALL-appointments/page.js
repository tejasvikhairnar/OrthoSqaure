        ...
        >
          <div
            className={`text-sm font-semibold mb-1 ${
              isToday
                ? "bg-gradient-to-r from-medivardaan-blue to-medivardaan-teal text-white w-6 h-6 rounded-full flex items-center justify-center"
              ...
              <div
                ...
                className={`text-xs p-1.5 rounded-md ${
                  apt.status === "confirmed"
                    ? "bg-gradient-to-r from-medivardaan-blue/10 to-medivardaan-teal/10 border-l-2 border-medivardaan-blue"
  ...
  return (
    <div className="max-w-[1600px] mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-[#0f7396]">
            APPOINTMENTS
          </h1>
        ...
        <div className="flex items-center gap-3">
          <Button
            variant="outline"
            size="sm"
            className="border-medivardaan-blue/20 hover:bg-medivardaan-blue/10"
          >
            <Calendar className="w-4 h-4 mr-2" />
            Export
          </Button>
          <Button className="bg-gradient-to-r from-medivardaan-blue to-medivardaan-teal hover:from-medivardaan-blue/90 hover:to-medivardaan-teal/90">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Card className="border-l-4 border-l-medivardaan-blue shadow-sm">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
              ...
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-medivardaan-blue/20 to-medivardaan-teal/20 flex items-center justify-center">
