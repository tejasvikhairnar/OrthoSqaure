  ...
  const columns = useMemo(() => [
    {
      ...
      cell: ({ row }) => (
        <span
          ...
          className="underline text-medivardaan-blue dark:text-medivardaan-teal hover:text-medivardaan-teal dark:hover:text-medivardaan-blue hover:cursor-pointer"
        >
          {row.original.rpl}
        </span>
      ),
...
<Spinner/></div>;
  ...
  return (
    <div className="min-h-screen">
      {/* Header */}
 {/* Header (Fixed) */}
<header className="w-full bg-gradient-to-r from-medivardaan-teal/10 via-medivardaan-blue/10 to-medivardaan-teal/10 dark:bg-gradient-to-r dark:from-medivardaan-blue/20 dark:via-medivardaan-teal/20 dark:to-medivardaan-blue/20 border border-medivardaan-teal/20 dark:border-medivardaan-teal/30 rounded-lg shadow-sm px-6 py-4 mb-2 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
      {/* Left Section */}
...
<div className="pt-20 space-y-8">
  ...
  const value = stats?.[item?.key];
          return (
          <Card key={item.title} className="bg-gradient-to-br from-medivardaan-teal/5 via-white/50 to-medivardaan-blue/5 dark:bg-gradient-to-br dark:from-medivardaan-blue/20 dark:via-medivardaan-teal/10 dark:to-medivardaan-blue/20 text-center shadow-md hover:shadow-xl transition-all border border-medivardaan-teal/20">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="bg-gradient-to-br from-medivardaan-teal/10 via-white/60 to-medivardaan-blue/10 dark:bg-gradient-to-br dark:from-medivardaan-blue/25 dark:via-medivardaan-teal/15 dark:to-medivardaan-blue/25 backdrop-blur-sm border border-medivardaan-teal/30 dark:border-medivardaan-teal/40 p-0">
